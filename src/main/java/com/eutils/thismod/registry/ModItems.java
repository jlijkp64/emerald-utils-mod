...
public class ModItems{
	...
	//BASIC ITEMS
	public static final Item EMERALD_STICK = new Item(new Item.Settings().group(ItemGroup.MATERIALS));
	
	//ITEMS BLOCKS
	public static final BlockItem COMPRESSED_EMERALD_BLOCK = new BlockItem(ModBlocks.COMPRESSED_EMERALD_BLOCK, new Item.Settings().group(ItemGroup.BUILDING_BLOCKS));
